...
- Messenger &raquo; [Signal](https://signal.org) en [Matrix](https://matrix.org/) &raquo; via Android App support vanaf Aurora, [Whisperfish](https://openrepos.net/content/rubdos/whisperfish) krijg ik nog niet goed werkend, en [xmatic](https://github.com/JimKnopfIoT/harbour-xmatic) via [OpenRepos](https://openrepos.net/content/jimknopfiot/xmatic).
...
- [Patchmanager for SailfishOS](https://github.com/sailfishos-patches/patchmanager) &raquo; [Chum](https://sailfishos-chum.github.io/apps/patchmanager/) &raquo; Niet alles is (nog) instelbaar, maar veel is wel patchbaar.
...
### Verzoeken om Sailfish OS versies
...
- [Ente Auth](https://ente.com/auth/) &raquo; via mail aan [support@ente.com](mailto:support@ente.com)
